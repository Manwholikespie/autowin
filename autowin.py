...
# ALIASES
print(bcolors.RED + "Now setting aliases for your convenience." + bcolors.ENDC)
...
gotodesktop = "cd ~/Desktop "
# goes to home folder and then to Desktop
os.system(gotodesktop)
